...
(() => {
  ...
  const VOYAGES = [
    ...
    { id: 'sainte-baume', titre: 'Sainte”baume', pays: 'France', theme: ['madeleine', 'montagne'], duree: '2j', 25
     -photo-1604518464016-f762bb025b1dw=800', dates: ['2025-03-29', '2025-05-17', '2025-09-20'], tags: ['Var', 'Grotte', 'Forêt'] },
